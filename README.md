...
The frontend pulls all its UI primitives from [`skateboard-ui`](https://github.com/stevederico/skateboard-ui). That package has **zero runtime dependencies**. Peers are `react`, `react-dom`, and `react-router` — already in this app.
